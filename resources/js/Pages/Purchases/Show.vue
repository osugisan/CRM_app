                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="mt-4 w-full mx-auto overflow-auto">
                                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="item in props.items" :key="item.id">
                                                            <td class="border-t-2 border-b-2 border-gray-200px-4 py-3">{{ item.item_id }}</td>
                                                            <td class="border-t-2 border-b-2 border-gray-200px-4 py-3">{{ item.item_name }}</td>
                                                            <td class="border-t-2 border-b-2 border-gray-200px-4 py-3">{{ item.item_price }}</td>
                                                            <td class="border-t-2 border-b-2 border-gray-200px-4 py-3">{{ item.qty }}</td>
                                                            <td class="border-t-2 border-b-2 border-gray-200px-4 py-3">{{ item.subtotal }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
