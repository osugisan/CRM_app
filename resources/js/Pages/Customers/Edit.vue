                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <section class="text-gray-600 body-font relative">
                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="radio" id="male" name="gender" v-model="form.gender" value="0" class="ml-2">
                                                    <label for="male" class="ml-2 mr-4">男性</label>
                                                    <input type="radio" id="female" name="gender" v-model="form.gender" value="1" class="ml-2">
                                                    <label for="female" class="ml-2 mr-4">女性</label>
                                                    <input type="radio" id="other" name="gender" v-model="form.gender" value="2" class="ml-2">
                                                    <label for="other" class="ml-2 mr-4">その他</label>
                            ...
                            <div class="p-2 w-full">
                                <button @click="deleteCustomer(form.id)" class="flex mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">削除</button>
                            </div>
